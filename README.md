...
I am an `Indie Game Developer` using **Godot Engine** and a `Sound Designer` making games and their sounds for the last 5 years. I have used a bunch of game engines previously but when Godot caught my attention, it became my first and only love to make games. I have also made my 1st commercial steam game called [The Void Project](https://store.steampowered.com/app/2681270/The_Void_Project/) with a friend of mine using one and only, Godot Engine. and am actively working on my 2nd one. Apart from my game dev hobby, I also make [Youtube Videos](https://www.youtube.com/@theyellowdude69). Specifically game devlogs and I have been doing so for 1 year.

<a href="https://www.youtube.com/@theyellowdude69/?sub_confirmation=1" title="Subscribe to my YouTube channel" rel="nofollow"> My Youtube Channel </a> <br>
<a href="https://github.com/AdilDevStuff?tab=repositories" title="Check out my repositories" rel="nofollow"> My Repositories </a> <br>
<a href="https://github.com/stars/AdilDevStuff/lists/godot-addons" title="Check out my Addons made for Godot" rel="nofollow">My Godot Addons</a> <br>
<a href="https://github.com/stars/AdilDevStuff/lists/godot-templates-projects" title="Check out my Samples & Templates made for Godot" rel="nofollow">My Godot Templates & Sample Projects</a> <br>
